...
// MARK: - ActivityAttributes (MUST be named LiveActivitiesAppAttributes for live_activities package compat)
...
// MARK: - Helper to format seconds as hh:mm:ss or mm:ss
